...
contract("Blockchain Credential Store tests", async accounts => {
  ...
  describe("Reverting state - Access Cotrol", () => {
    ...
    it("Test: revert state when uploading images without permission", async () => {
      await expectRevert(instance.setImage(image_hash_decoded_1, image_hex_filename_1, 'Thu Mar 12 2021 14:56:28 GMT+0200 (Eastern European Standard Time)', { from: accounts[5] }), 'Caller is not a user');
    });
  ...
  describe("Store and Retrieve images and files", () => {
    ...
    it("Test: store and retrieve an image", async () => {
      ...
      await instance.setImage(image_hash_decoded_1, image_hex_filename_1, 'Thu Mar 12 2021 14:56:28 GMT+0200 (Eastern European Standard Time)', { from: accounts[0] })
