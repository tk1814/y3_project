  ...
  render() {
    return (
      ...
      <div className="about_bg">
        ...
        <div className="mt-3 h8">1. Download the MetaMask browser extension <a style={{color: '#6e967a'}} href='https://metamask.io/download' target="_blank" rel="noopener noreferrer">here</a> </div>
