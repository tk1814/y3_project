            ...
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto white-text">
                ...
                <div style={{ flexDirection: 'row', alignItems: 'center', display: 'flex', fontWeight: 'bold', fontSize: '1.15em' }}>
                  <label className='mr-5'> <FcStackOfPhotos size="5em" /> <br></br><br></br> Upload images</label>
                  <label className='mr-5'> <FcDocument size="5em" /> <br></br><br></br> Store documents</label>
                  <label className='mr-5' > <FaEthereum style={{ color: '#6e967a' }} size="5em" /> <br></br><br></br> Interact with ethereum</label>
                  <label className='mr-5'> <FcShare size="5em" /> <br></br><br></br> Share certificates</label>
                  <label className='mr-5'> <FcLock size="5em" /> <br></br><br></br> Secure your files</label>
                </div>
                <p>&nbsp;</p>
                <p>&nbsp;</p>

                <div className='small_space mb-5'>
                  <div className='h7 mb-2 mt-5'>CURRENT ETH PRICE (1 ether) <FcSalesPerformance size="2em" /></div>
